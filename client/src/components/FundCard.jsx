        ...
        <div className='sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer' onClick={handleClick}>
            ...
            <div className='flex flex-col p-4'>
                ...
                <div className='block'>
                    ...
                    <p className='mt-[5px] font-epilogue font-normal text-[#808191] text-left leading-[18ps] truncate'>{description}</p>
                </div>
                ...
                <div className='flex justify-between flex-wrap mt-[15px] gap-2'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <p className='mt-[3px] font-epilogue font-normal text-[12px] leading-[18px] text-[#808191] sm:max-w-[120px] truncate'>Days Left {remainingDays}</p>
                    </div>
                </div>
